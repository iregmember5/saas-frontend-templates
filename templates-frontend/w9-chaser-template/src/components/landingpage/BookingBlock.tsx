  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createAppointment({
        ...
        appointment_type:
          appointmentType === "other" ? customAppointmentType : appointmentType,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <p className="text-center text-theme-neutral mb-8">
            {value.booking_type === "office" &&
              "Schedule an in-office appointment"}
            {value.booking_type === "mobile" && "Book a mobile notary visit"}
            {value.booking_type === "remote" &&
              "Schedule a remote online notarization (RON)"}
          </p>
